...
@Component
public class UpdateASeriousData {
    ...
    public void updateAHealthData(){
        ...
        for(int i=0;i<size;i++){
            int aData = studao.taskUpdateSeriousACase(insList[i],theda);
            System.out.println("更新"+insList[i]+"serious data");
        }
